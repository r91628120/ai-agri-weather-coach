...
本 Worker 是 AIAKOS 的衛星資料服務層，以 Cloudflare Workers、Hono 與 Copernicus Data Space Ecosystem（CDSE）建置。v1.0 正式提供 Sentinel-2 L2A 農地 NDVI 統計，並保留影像、搜尋、歷史與 AI 分析端點的版本化骨架。
...
詳細介面見 [NDVI-STATISTICAL-API.md](./NDVI-STATISTICAL-API.md)，架構見 [SATELLITE-ARCHITECTURE.md](./SATELLITE-ARCHITECTURE.md)。
